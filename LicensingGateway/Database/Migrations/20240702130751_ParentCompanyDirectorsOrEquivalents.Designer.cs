...
namespace Database.Licensing.Gateway.Migrations
{
    ...
    [Migration("20240702130751_ParentCompanyDirectorsOrEquivalents")]
    partial class ParentCompanyDirectorsOrEquivalents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entites.Application", b =>
                {
                    ...
                    b.Property<bool?>("NewlyIncorporatedCompany")
                        .HasColumnType("bit");

                    b.Property<DateOnly?>("NextFinancialYear")
                        .HasColumnType("date");

                    b.Property<bool?>("OneOrMoreParentCompanies")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Database.Entites.DirectorGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("OneOrMoreIndividuals")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Database.Entites.FeedbackType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Type = "ApplicationFormPartOne"
                        },
                        new
                        {
                            Id = 2,
                            Type = "ApplicationFormPartTwo"
                        },
                        new
                        {
                            Id = 3,
            ...
            modelBuilder.Entity("Database.Entites.Director", b =>
                {
                    ...
                    b.HasOne("Database.Entites.DirectorGroup", "Group")
                        .WithMany("Directors")
            ...
            modelBuilder.Entity("Database.Entites.DirectorGroup", b =>
                {
                    ...
                    b.HasOne("Database.Entites.DirectorType", "Type")
                        .WithMany()
