...
param automationStorageAccountName string
param licenseHolderCustomDomain string
...
module function_app_main 'modules/function.app.bicep' = {
  ...
  params: {
    ...
    keyVaultName: keyVaultName
    licenseHolderDefaultHostName: empty(licenseHolderCustomDomain) ? webApp_licensing_gateway.outputs.defaultHostName: licenseHolderCustomDomain 
    automationStorageAccountName: automationStorageAccountName
  }
}
